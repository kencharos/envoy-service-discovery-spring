...
public final class ReactorBackend2ServiceGrpc {
    ...
    public static final class ReactorBackend2ServiceStub extends io.grpc.stub.AbstractStub<ReactorBackend2ServiceStub> {
        ...
        public reactor.core.publisher.Flux<my.sdtest.backend2.B2Response> helloBackend2Stream(reactor.core.publisher.Flux<my.sdtest.backend2.B2Request> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.manyToMany(reactorRequest, delegateStub::helloBackend2Stream);
        }
    ...
    public static abstract class Backend2ServiceImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Flux<my.sdtest.backend2.B2Response> helloBackend2Stream(reactor.core.publisher.Flux<my.sdtest.backend2.B2Request> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    ...
                    .addMethod(
                            my.sdtest.backend2.Backend2ServiceGrpc.getHelloBackend2StreamMethod(),
            ...
            switch (methodId) {
                case METHODID_HELLO_BACKEND2STREAM:
                    return (io.grpc.stub.StreamObserver<Req>) com.salesforce.reactorgrpc.stub.ServerCalls.manyToMany(
                            (io.grpc.stub.StreamObserver<my.sdtest.backend2.B2Response>) responseObserver,
                            serviceImpl::helloBackend2Stream);
                default:
                    throw new java.lang.AssertionError();
            }
        }
